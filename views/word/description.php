...
if (isset($this->params['results'])) {
    ...
    if ($this->params['results']['status'] == 'success' 
            && isset($this->params['results']['data'])
            && count($this->params['results']['data'])) {
?>
...
<?php
        ...
        $this->params['breadcrumbs'][] = ['label' => 'Составление слов', 'url' => ['/']];
        $this->params['breadcrumbs'][] = ['label' => 'Ошибка'];
?>
